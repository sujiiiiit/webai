...
const LoadingFallback = () => (
  <div className="p-4 bg-bolt-elements-background-depth-1 dark:bg-bolt-elements-background-depth-1 rounded-lg border border-light dark:border-light">
...
export default function ConnectionsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        className="bg-bolt-elements-background dark:bg-bolt-elements-background rounded-lg border border-light dark:border-light"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="p-6">
          <button
            ...
            className={classNames(
              ...
              'hover:bg-bolt-elements-item-backgroundActive/10 hover:text-color-primary',
              'dark:hover:bg-bolt-elements-item-backgroundActive/10 dark:hover:text-color-primary',

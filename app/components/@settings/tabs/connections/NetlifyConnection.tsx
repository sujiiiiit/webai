      ...
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-color-primary">Netlify Connection</h2>
          </div>
        </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2 ml-auto">
                ...
                >
                  {fetchingStats ? (
                    <>
                      <div className="i-ph:spinner-gap w-4 h-4 animate-spin text-color-primary dark:text-color-primary" />
                      <span className="text-color-primary dark:text-color-primary">
                        Refreshing...
                      </span>
                    </>
                    ...
                    <>
                      <ArrowPathIcon className="h-4 w-4 text-color-primary dark:text-color-primary" />
                      <span className="text-color-primary dark:text-color-primary">
                        Refresh Stats
                      </span>
                    </>

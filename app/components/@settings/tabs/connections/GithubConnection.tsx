            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-color-primary mb-3">Top Languages</h4>
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium text-color-primary mb-2">Repository Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-color-primary mb-2">Contribution Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-color-primary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-color-primary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

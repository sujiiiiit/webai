    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-medium text-color-primary">Preferences</span>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-medium text-color-primary">Time Settings</span>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-medium text-color-primary">Keyboard Shortcuts</span>
        </div>

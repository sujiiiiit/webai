...
export default function LocalProvidersTab() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header section */}
        <div className="flex items-center justify-between gap-4 border-b border-light pb-4">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <h4 className="text-sm font-medium text-color-primary">Installed Models</h4>
                    </div>
                    {isLoadingModels ? (
                      <div className="flex items-center gap-2">
                        <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="space-y-2">
                              <div className="flex items-center gap-2">
                                <h5 className="text-sm font-medium text-color-primary">{model.name}</h5>
        ...
        <div className="border-t border-light pt-6 mt-8">
          <h3 className="text-lg font-semibold text-color-primary mb-4">Other Local Providers</h3>

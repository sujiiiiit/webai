  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-light bg-webai-elements-background-depth-1 text-color-primary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-webai-elements-textSecondary', className)} {...props} />;
  },
);
